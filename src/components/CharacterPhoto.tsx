    ...
    <div className="flex flex-col items-center space-y-4">
      ...
      {!readOnly && (
        <>
          ...
          <label
            htmlFor="photo-input"
            className="flex items-center gap-2 cursor-pointer bg-[#1a1a1a] text-[#00ffe1] border border-[#00ffe1] rounded-lg px-4 py-2 hover:bg-[#2a2a2a] transition-colors shadow-[0_0_10px_rgba(0,255,225,0.2)] hover:shadow-[0_0_15px_rgba(0,255,225,0.3)]"
          >
            <Upload size={20} />
